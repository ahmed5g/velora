...
import com.tech.Velora.user.mapper.UserMapper;
import com.tech.Velora.user.reposioty.UserReposioty;
...
public class UserService {
    ...
    private final UserReposioty userRepository;
    private final UserMapper userMapper;

    public UserService(UserReposioty userRepository, UserMapper userMapper) {
